"""
SWIFT SYSTEM - CAR_004 Controller
Module 2 Baseline Traffic Simulation

Independent controller for CAR_004 (Pearl White - Clockwise Loop).
...
class Car004Controller:
    VEHICLE_ID = "CAR_004"
    SPAWN_LANE = "LANE_J1_J7_NW"
    SPAWN_X = -263.08
    SPAWN_Y = 258.14
    SPAWN_HEADING = 2.3562
    ...
    def __init__(self):
        ...
        self.lane_loop = VEHICLE_ROUTES.get("CAR_004", ["LANE_J1_J7_NW", "LANE_J7_J1_SE", "LANE_J1_J8_NE", "LANE_J8_J1_SW"])
