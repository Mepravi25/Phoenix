"""
SWIFT SYSTEM - CAR_001 Controller
Module 2 Baseline Traffic Simulation

Independent controller for CAR_001 (Metallic Blue - Clockwise Loop).
...
class Car001Controller:
    ...
    def update_logic(self, dt: float):
        ...
        if lead_dist <= CAR_LENGTH + 0.2:  # Emergency hard collision prevention
            safety_stop = True
        ...
        # 5. Smooth Movement (Acceleration & Deceleration)
