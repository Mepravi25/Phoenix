"""
SWIFT SYSTEM - CAR_003 Controller
Module 2 Baseline Traffic Simulation

Independent controller for CAR_003 (Silver Gray - Clockwise Loop).
...
class Car003Controller:
    VEHICLE_ID = "CAR_003"
    SPAWN_LANE = "LANE_J4_J5_SE"
    SPAWN_X = -235.01
    SPAWN_Y = -253.58
    SPAWN_HEADING = -0.4636
    ...
    def __init__(self):
        ...
        self.lane_loop = VEHICLE_ROUTES.get("CAR_003", ["LANE_J4_J5_SE", "LANE_J5_J6_WB", "LANE_J6_J4_NE"])
