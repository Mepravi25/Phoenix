...
# Build Spatial Hash Grid for Obstacles (Cell size = 50m)
OBS_GRID_SIZE = 50.0
obs_grid = {}

def add_obs_to_grid(item, item_type):
    # compute AABB of item + max clearance
...
t1 = time.time()
print(f"\n--- ULTRAFAST TREE PLACEMENT RESULTS (Time: {t1 - t0:.2f}s) ---")
